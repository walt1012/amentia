...
- `release_evidence_contract.py`: validates internal dry-run and publish-rehearsal evidence artifacts, including structured readiness command content, release-plan, release-rehearsal JSON, rehearsal Markdown, manual acceptance checklist terms, dry-run installer asset integrity, cross-file release consistency, and asset-contract consistency, before workflow upload without adding extra public release assets.
...
- `test_release_evidence_contract.py`: checks internal release evidence artifact sets, structured readiness, release-plan, release-rehearsal JSON consistency, dry-run installer asset integrity, rehearsal and manual acceptance Markdown content, cross-file agreement, and missing or extra file rejection.
