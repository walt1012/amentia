...
- `smoke_launch_macos_app.py`: launches the packaged `Pith.app` on macOS CI with an isolated app support root and verifies app/runtime startup plus runtime database initialization.
