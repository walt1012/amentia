...
- `release_readiness.py`: prepares maintainer-facing Markdown and machine-readable JSON readiness reports before dispatching the release workflow, and keeps manual dispatch inputs aligned with the safe dry-run-first path.
