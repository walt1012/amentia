...
- `package_contract.py`: centralizes the stable macOS package contract shared by packaging, release manifests, distribution validation, packaged smoke checks, locked size-budget validation, and direct `PithPackage.json` validation in CI/release workflows.
