...
- `smoke_launch_macos_app.py`: launches the packaged `Pith.app` on macOS CI with an isolated app support root and verifies the app/runtime stay alive briefly.
