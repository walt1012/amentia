...
- `release_evidence_contract.py`: validates internal dry-run and publish-rehearsal evidence artifacts, including structured readiness and release-plan JSON keys, manual acceptance checklist terms, cross-file release consistency, and asset-contract consistency, before workflow upload without adding extra public release assets.
...
- `test_release_evidence_contract.py`: checks internal release evidence artifact sets, structured readiness and release-plan JSON consistency, manual acceptance checklist content, cross-file agreement, Markdown shape, and missing or extra file rejection.
