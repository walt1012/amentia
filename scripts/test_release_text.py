...
def main() -> int:
  ...
  require_contains(" ".join(RELEASE_NOTES_REQUIRED_PHRASES), "local service status")
  require_contains(" ".join(RELEASE_NOTES_REQUIRED_PHRASES), "app package metadata")
  require_contains(" ".join(RELEASE_NOTES_REQUIRED_PHRASES), "smoke package metadata")
  ...
  require_contains(first_run_path_copy(), "workspace safety")
  ...
  require_contains(developer_notes, "app package metadata")
  require_contains(developer_notes, "smoke package metadata")
  ...
  require_contains(developer_notes, "local service status")
  ...
  require_contains(guide, "Check that Web Search and workspace safety are ready.")
