...
final class AmentiaAppDelegate: NSObject, NSApplicationDelegate {
  private static weak var mainWindow: NSWindow?
  private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("amentia.main-window")
