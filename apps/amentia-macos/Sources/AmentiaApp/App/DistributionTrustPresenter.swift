...
struct DistributionPackageMetadata: Equatable {
  ...
  let amentiaAccountRequired: Bool
  ...
  static func load(bundle: Bundle = .main) -> DistributionPackageMetadata {
    guard let url = bundle.url(forResource: "AmentiaPackage", withExtension: "json"),
  ...
  static func fromManifestData(_ data: Data) -> DistributionPackageMetadata? {
    ...
    return DistributionPackageMetadata(
      ...
      amentiaAccountRequired: bool(manifest, "amentiaAccountRequired", fallback: false),
...
enum DistributionTrustPresenter {
  static func summary(
    ...
    default:
      return DistributionTrustSummary(
        ...
        advancedDetail: "Release DMGs include app package metadata, README-FIRST.txt, SHA-256 checksum, and a release manifest.",
        setupDetail: nil
      )
    }
  }
  ...
  private static func identitySummary(_ metadata: DistributionPackageMetadata) -> String {
    metadata.amentiaAccountRequired ? "Amentia account required" : "no Amentia account required"
  }
