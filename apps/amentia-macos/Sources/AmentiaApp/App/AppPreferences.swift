...
enum AppPreferences {
  private static let lastWorkspacePathKey = "amentia.lastWorkspacePath"
  private static let selectedSetupModelIDKey = "amentia.selectedSetupModelID"
  private static let localExecutionSafetyModeKey = "amentia.localExecutionSafetyMode"
  private static let appPreferenceKeyPrefix = "amentia."
