...
extension LocalModelCatalog {
  private static let pausedDownloadIDKey = "amentia.pausedModelDownloadID"
  private static let pausedDownloadBytesReceivedKey = "amentia.pausedModelDownloadBytesReceived"
  private static let pausedDownloadTotalBytesKey = "amentia.pausedModelDownloadTotalBytes"
  private static let pausedDownloadUpdatedAtKey = "amentia.pausedModelDownloadUpdatedAt"
