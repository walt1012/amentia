...
struct InspectorPane: View {
  ...
  @AppStorage("amentia.inspector.workspaceExpanded") private var workspaceExpanded = false
  @AppStorage("amentia.inspector.localModelExpanded") private var localModelExpanded = false
  @AppStorage("amentia.inspector.advancedExpanded") private var advancedExpanded = false
  @AppStorage("amentia.inspector.memoryExpanded") private var memoryExpanded = false
  @AppStorage("amentia.inspector.pluginManagerExpanded") private var pluginManagerExpanded = false
  @AppStorage("amentia.inspector.threadExpanded") private var threadExpanded = false
  @AppStorage("amentia.inspector.selectedItemExpanded") private var selectedItemExpanded = false
  @AppStorage("amentia.inspector.selectedPluginExpanded") private var selectedPluginExpanded = false
  @AppStorage("amentia.inspector.selectedContextExpanded") private var selectedContextExpanded = false
  @AppStorage("amentia.inspector.selectedSandboxExpanded") private var selectedSandboxExpanded = false
  @AppStorage("amentia.inspector.selectedAttributesExpanded") private var selectedAttributesExpanded = false
  ...
  var body: some View {
    ScrollView {
      ...
      .padding(20)
      .animation(AmentiaMotionStyle.sectionReveal, value: workspaceExpanded)
      .animation(AmentiaMotionStyle.sectionReveal, value: localModelExpanded)
      .animation(AmentiaMotionStyle.sectionReveal, value: selectedItemExpanded)
      .animation(AmentiaMotionStyle.sectionReveal, value: selectedContextExpanded)
      .animation(AmentiaMotionStyle.sectionReveal, value: selectedPluginExpanded)
      .animation(AmentiaMotionStyle.sectionReveal, value: selectedSandboxExpanded)
      .animation(AmentiaMotionStyle.sectionReveal, value: advancedExpanded)
    }
    .frame(minWidth: 280)
    .background(AmentiaVisualStyle.inspectorBackground)
  }
...
private struct InspectorSectionCard: ViewModifier {
  func body(content: Content) -> some View {
    content
      ...
      .shadow(color: AmentiaVisualStyle.panelShadow, radius: 6, x: 0, y: 2)
  }
}
