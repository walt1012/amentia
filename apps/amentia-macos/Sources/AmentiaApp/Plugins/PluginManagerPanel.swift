...
struct PluginManagerPanel: View {
  ...
  var body: some View {
    ...
    .animation(AmentiaMotionStyle.sectionReveal, value: viewModel.pluginManagerSection)
    .animation(AmentiaMotionStyle.quick, value: viewModel.hasPluginLifecycleOperation())
  }
...
private struct PluginSectionChip: View {
  ...
  private var background: Color {
    isSelected ? Color.accentColor.opacity(0.10) : AmentiaVisualStyle.panelBackground
  }

  private var border: Color {
    isSelected ? Color.accentColor.opacity(0.22) : AmentiaVisualStyle.panelBorder
  }
}
