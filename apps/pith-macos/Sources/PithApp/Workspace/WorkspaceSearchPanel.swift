...
struct WorkspaceSearchPanel: View {
  ...
  var body: some View {
    ...
    .animation(PithMotionStyle.sectionReveal, value: viewModel.isWorkspaceSearching)
    .animation(PithMotionStyle.sectionReveal, value: viewModel.workspaceSearchResults.count)
  }
