...
use pith_plugin_host::{
  build_command_registry, inspect_plugin_bundle, install_plugin_bundle, remove_local_plugin_bundle,
...
use pith_protocol::{
  ...
  MemoryCreateParams, MemoryCreateResult, MemoryListResult, PluginCommandRunParams,
  PluginInstallParams, PluginInstallResult, PluginListResult, PluginRemoveParams,
  PluginRemoveResult, PluginSetEnabledParams, PluginSetEnabledResult, ServerCapabilities,
