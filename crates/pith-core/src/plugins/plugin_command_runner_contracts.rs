...
pub(super) const PLUGIN_RUNNER_CONNECTOR_WORKFLOW_CONTRACT: &str = "pith.connectorWorkflow.v1";
pub(super) const PLUGIN_RUNNER_CONNECTOR_WORKFLOW_STATUSES: &[&str] =
  &["completed", "inspected", "prepared", "retryNeeded"];
pub(super) const PLUGIN_RUNNER_REMOTE_WRITE_CONTRACT: &str = "pith.connectorRemoteWrite.v1";
