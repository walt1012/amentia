  ...
  TurnStartExecutionOutput {
    ...
    items: vec![
      ...
      TimelineItem {
        ...
        content: "Amentia recovered this turn after an internal runtime error.".to_string(),
      ...
      TimelineItem {
        ...
        content: "The local turn stopped before Amentia could finish. Try again when ready."
          .to_string(),
        attributes: Some(HashMap::from([
