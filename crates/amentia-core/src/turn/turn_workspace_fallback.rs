...
pub(super) fn execute_no_workspace_turn(
  ...
  items.push(TimelineItem {
    ...
    content: "Open a project before asking Amentia to inspect files.".to_string(),
    attributes: None,
  });
  items.push(TimelineItem {
    ...
    content: format!(
      "Amentia received your message in {}, but project tools need an opened workspace first.",
