...
use amentia_model_runtime::llama_cpp_timeout_seconds;
...
const AMENTIA_ACCOUNT_REQUIRED: &str = "false";
...
fn insert_local_execution_safety_metrics(metrics: &mut HashMap<String, String>) {
  insert_metric(metrics, "amentiaAccountRequired", AMENTIA_ACCOUNT_REQUIRED);
  insert_metric(
    metrics,
