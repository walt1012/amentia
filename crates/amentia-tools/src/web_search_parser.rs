...
mod tests {
  ...
  fn parses_duckduckgo_lite_results() {
    let html = r#"
      <a rel="nofollow" href="//duckduckgo.com/l/?uddg=https%3A%2F%2Fexample.com%2Famentia&amp;rut=abc" class='result-link'>Example <b>Amentia</b></a>
    ...
    assert_eq!(results[0].title, "Example Amentia");
