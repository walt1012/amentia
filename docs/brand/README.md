...
Amentia's current identity direction is a refined blue monogram on a clean
...
- Keep the SVG and PNG visually aligned. The PNG is the packaged macOS icon
  source; the SVG is the editable vector reference for that same mark.
