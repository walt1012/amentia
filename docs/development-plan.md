...
- Release copy requirements are centralized so release notes, install guides,
  sidecar validation, and DMG staging do not drift.
- CI change classification treats release copy contract edits as package-impacting
  changes.
