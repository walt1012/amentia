...
- Release automation: change-aware CI lanes, release dry-run, downloaded-asset
  ...
  lookup, workflow policy tests, shared release input guards, evidence-step
  ordering, dry-run artifact lookup and verification, structured readiness and
  release-plan evidence validation with tag, mode, cross-file, and asset
  consistency, and guarded publish commands.
