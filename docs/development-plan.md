...
- Release automation: change-aware CI lanes, release dry-run, downloaded-asset
  ...
  structured readiness command, release-plan, rehearsal, dry-run installer
  asset, and manual-acceptance evidence validation with tag, mode, cross-file,
  asset, and user-path consistency, and guarded publish commands.
