...
- Release automation: change-aware CI lanes, release dry-run, downloaded-asset
  ...
  structured readiness and guarded publish commands, release-plan, rehearsal,
  dry-run installer asset, and manual-acceptance evidence validation with tag,
  mode, cross-file, asset, and user-path consistency.
