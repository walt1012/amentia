...
- Done: first-use model download flow, verified catalog activation, active model recovery, bounded shell/model/web-search paths, runtime request supervision, retryable cancellation state with clear failure feedback, symlink-safe workspace tools, progressive inspector surfaces, and native sandbox diagnostics.
